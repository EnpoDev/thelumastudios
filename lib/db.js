...
function initDatabase() {
  ...
  // Admin user setup is handled by seed script (npm run db:seed)
  // No default admin user is created here for security reasons
  // See scripts/seed.js for admin user creation
